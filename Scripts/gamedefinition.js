    ...
    milestones:
    {
        achievements:
            [
                ...
                new Milestone(39, "Overproductive Start", 21, () => "First Barrel produces more than " + formatNumber(1e63) + " Scrap", () => Barrel.getIncomeForLevel(0).gte(1e63) && game.dimension == 0, ["<amount>", "formatNumber(1e63)"]),
                ...
                new Milestone(66, "Need more\nInfinities", 30, () => "\n\nFirst Barrel produces more than " + formatNumber(Decimal.pow(2, 1024)) + " Scrap", () => Barrel.getIncomeForLevel(0)
                    .gte(Decimal.pow(2, 1024)) && game.dimension == 0, ["<amount>", "formatNumber(Decimal.pow(2, 1024))"]),
                ...
                new Milestone(67, "Need more\nInfinities II", 30, () => "\n\nFirst Barrel produces more than " + formatNumber(Decimal.pow(4, 1024)) + " Scrap", () => Barrel.getIncomeForLevel(0)
                    .gte(Decimal.pow(4, 1024)) && game.dimension == 0, ["<amount>", "formatNumber(Decimal.pow(4, 1024))"]),
                ...
                new Milestone(68, "Need more\nInfinities III", 30, () => "\n\nFirst Barrel produces more than " + formatNumber(Decimal.pow(8, 1024)) + " Scrap", () => Barrel.getIncomeForLevel(0)
                    .gte(Decimal.pow(8, 1024)) && game.dimension == 0, ["<amount>", "formatNumber(Decimal.pow(8, 1024))"]),
                ...
                new Milestone(235, "They Call Me Santa", 117, "Send 100 Gifts to the people", () => game.stats.giftsSent.gte(100)),
                new Milestone(147, "Time to go AFK...", 87, "Max. the first auto buyer", () => game.autos.autoBetterBarrels.level > 116),
                new Milestone(229, "Need more Nice", 30, () => "First Barrel produces more than " + formatNumber(new Decimal("6e9420")) + " Scrap", () => Barrel.getIncomeForLevel(0).gte(new Decimal("6e9420")) && game.dimension == 0, ["<amount>", "formatNumber(new Decimal('6e9420'))"]),
