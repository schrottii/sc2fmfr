    ...
    milestones:
    {
        achievements:
            [
                ...
                new Milestone(258, "A dig pig", 111, "Have 1M cogwheels at once", () => game.cogwheels.amount.gte(1e6)),
                ...
                new Milestone(270, "Second Tire Club", 88, () => "Reach " + formatNumber(new Decimal("1e1e25")) + " Tires\nOnly an apple is missing!", () => game.tires.amount.gte(new Decimal("1e1e25")), ["<amount>", "formatNumber(new Decimal('1e1e25'))"]),
