    ...
    milestones:
    {
        achievements:
            [
                ...
                new Milestone(42, "Infinity", 19, () => "Reach " + formatNumber(Decimal.pow(2, 1024)) + " Scrap", () => game.highestScrapReached.gte(Decimal.pow(2, 1024)), ["<amount>", "formatNumber(Decimal.pow(2, 1024))"], ["<amount>", "formatNumber(Decimal.pow(2, 1024))"], "red"),
