    ...
    [
        new Scene("Loading",
            ...
            function () {
                ...
                ctx.fillText("v1.2 (v1.9)", w * 0.99, h - w * 0.01);
            }),
        new Scene("Barrels",
            [
                    ...
                    if (b != null && b.isClicked()) {
                        ...
                        if (timeSinceLastBarrelClick <= 0.2 && lastClickedBarrel === i && game.settings.destroyBarrels) {
                            if (game.fragment.isUnlocked() == true) {
                                game.fragment.amount = game.fragment.amount.add(barrels[i].level / 10);
                            }
                            barrels[i] = undefined;
        ...
        new Scene("Fragment",
            [
                ...
                new UIText(() => "Barrel Fragments: " + Math.round(game.fragment.amount), 0.5, 0.2, 0.04, "yellow"),
                new UIText(() => "Fragments can be earned by destroying barrels.", 0.5, 0.3, 0.04, "black"),
                new UIFragmentUpgrade(game.fragment.upgrades.scrapBoost, images.upgrades.moreScrap, 0.65, "Get More Scrap", "gray"),
                new UIFragmentUpgrade(game.fragment.upgrades.magnetBoost, images.upgrades.magnetBoost, 0.75, "Get More Magnets", "darkgray"),
            ],
            function () {
                ctx.fillStyle = colors.bg;
                ctx.fillRect(0, 0, w, h);
                ...
                ctx.fillStyle = colors.table;
                ctx.fillRect(w * 0.05, h * 0.185, w * 0.9, h * 0.06);
            }),
